...
const Messages = () => {
    ...
    return (
        <div className="w-full h-full flex flex-col bg-tech-primary font-sans overflow-hidden">
            <div className="w-full h-full flex flex-col bg-tech-secondary/40 overflow-hidden">

                {/* Layout Principal Flexible */}
                <div className="flex flex-1 min-h-0 w-full overflow-hidden">
                    
                    {/* Panel Izquierdo: Lista de Chats */}
                    <div className={`w-full lg:w-[360px] xl:w-[380px] shrink-0 border-r border-tech-surface flex flex-col min-h-0 overflow-hidden bg-tech-secondary/30 ${isMobile && activeChatKey ? 'hidden' : 'flex'}`}>
                    ...
                    <div className={`flex-1 min-h-0 flex flex-col bg-tech-primary/20 p-2 md:p-3 overflow-hidden ${isMobile && !activeChatKey ? 'hidden' : 'flex'}`}>
                        {activeUser ? (
                            <>
                                ...
                                {/* CAJA DEL HISTORIAL DE MENSAJES */}
